  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["authentication-authentication-module"], {
    ...
    function srcAppAuthentication404NotFoundComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      NotfoundComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 10,
        vars: 0,
        consts: [[1, "error-box"], [1, "error-body", "text-center"], [1, "error-title", "text-danger"], [1, "text-uppercase", "error-subtitle"], [1, "text-muted", "m-t-30", "m-b-30"], ["routerLink", "/dashboard", 1, "btn", "btn-danger", "btn-rounded", "waves-effect", "waves-light", "m-b-40"]],
    ...
    function srcAppAuthenticationLogin2Login2ComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function Login2Component_div_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Login2Component_div_2_Template_button_click_35_listener() {
            ...
            return ctx_r11.CallLoginFunction();
          });
      ...
      function Login2Component_div_3_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Login2Component_div_3_Template_button_click_19_listener() {
            ...
            return ctx_r16.CancelledForgot();
          });
      ...
      function Login2Component_div_4_div_5_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Login2Component_div_4_div_5_Template_a_click_13_listener() {
            ...
            return ctx_r19.showRecoverForm();
          });
      ...
      function Login2Component_div_4_div_6_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Login2Component_div_4_div_6_Template_button_click_7_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r24);

            var ctx_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

            return ctx_r25.VerifyOtp();
          });
        ...
        _createClass(Login2Component, [{
          ...
          value: function SendOtp(obj) {
            ...
            this.service.post("user/verify-otp/", obj).subscribe(function (res) {
              if ([200, 201].includes(res.code)) {
                ...
                _this8.toaster.success('Otp verified successfully', '', {
                  timeOut: 1000
                }); //    $('#exampleModalCenter').modal('hide')
          ...
          value: function ResendOtp(obj, msg) {
            ...
            this.service.post("user/send-otp-to-old-user/", obj).subscribe(function (res) {
              if ([200, 201].includes(res.code)) {
                //  $('#exampleModalCenter').modal({backdrop: 'static', keyboard: false}) 
                _this9.toaster.success(" Otp sent ".concat(msg), 'Resend OTP', {
                  timeOut: 1000
                });
              }
            });
      ...
      Login2Component.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        selectors: [["app-login"]],
        viewQuery: function Login2Component_Query(rf, ctx) {
          if (rf & 1) {
        ...
        template: function Login2Component_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Login2Component_Template_button_click_22_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Login2Component_Template_button_click_24_listener() {
